...
| `areasProp`      | `array`           |    -     |   -    |    -    | specifies named grid areas. |
| `columnsProp`    | `string`,`array`,`object` |    -     |   -    |    -    | defines the line names and track sizing functions of the grid columns. |
...
| `rowsProp`       | `string`,`array`  |    -     |   -    |    -    | defines the line names and track sizing functions of the grid rows. |
