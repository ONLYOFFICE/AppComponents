...
import { StyledDropDown, StyledCountryItem, StyledSearchPanel } from "./StyledPhoneInput";
...
describe("<PhoneInput />", () => {
    ...
    it('should applies theme props to nested styled components', () => {
        ...
        expect(styledCountryItem).toHaveStyleRule("background-color", Base.phoneInput.itemBackgroundColor);
        
        const styledSearchPanel = renderer.create(<StyledSearchPanel />).toJSON();
        expect(styledSearchPanel).toHaveStyleRule("color", Base.phoneInput.placeholderColor, {
